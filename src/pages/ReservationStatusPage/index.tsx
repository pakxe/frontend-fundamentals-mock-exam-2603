...
import { RESERVATION } from 'pages/ReservationStatusPage/constant';
...
export function ReservationStatusPage() {
  ...
  return (
    ...
    >
      ...
      {/* 날짜 선택 */}
      <SelectDate value={date} onChangeDate={v => setDate(v)} />
        ...
        >
          ...
          >
            ...
            <div
              ...
              `}
            >
              {timeline.hourLabels.map(t => {
                const left = (timeToMinutes(t, RESERVATION.START) / timeline.totalMinutes) * 100;
                return (
                  <Text
                    key={t}
                    typography="t7"
              ...
              >
                ...
                >
                  {roomReservations.map(res => {
                    const left = (timeToMinutes(res.start, RESERVATION.START) / timeline.totalMinutes) * 100;
                    const width =
                      ((timeToMinutes(res.end, RESERVATION.START) - timeToMinutes(res.start, RESERVATION.START)) /
